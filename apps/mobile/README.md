...
Expo SDK 55 / React Native 0.83 / React 19.2, Expo Router and NativeWind v4.
...
M0-T07 generates `deviceId` with Expo Crypto and persists it in local metadata. It survives ordinary restarts and is regenerated after a clean installation. The initialized database context exposes it for authentication and synchronization envelopes.
